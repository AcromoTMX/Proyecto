...
$tareas = [
  array('nombre' => 'tarea 1', 'descripcion' => 'descripcion tarea 1'),
  array('nombre' => 'tarea 2', 'descripcion' => 'descripcion tarea 2'),
  array('nombre' => 'tarea 3', 'descripcion' => 'descripcion tarea 3')
];
...
//   echo "Nombre tarea: ". $tareas[$i]['nombre'];
//   echo " Descripcion de la tarea: ". $tareas[$i]['descripcion'];
//   echo "<br>";
