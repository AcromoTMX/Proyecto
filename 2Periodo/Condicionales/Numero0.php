...
<body class="is-preload">
        ...
        <div id="main">
            <div class="inner">
                ...
                <section id="banner">
                    ...
                    <form method="POST">
        <label for="numero">Ingrese un valor numerico: </label>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($num > 0) {
            ...
            echo '<p class="Pos">El valor ingresado es positivo</p>';

        } elseif ($num < 0) {

            echo '<p class="Neg">El valor ingresado es negativo</p>';

        } elseif ($num == 0) {

            echo '<p class="Null">El valor ingresado es 0</p>';
