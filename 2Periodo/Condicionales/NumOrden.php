...
<body class="is-preload">
    ...
    <div id="wrapper">
        ...
        <label for="n3">Ingrese el tercer numero: </label> <br>
    ...
    if($num1 == $num2 && $num2 == $num3){
        ...
        echo "El número del medio es " . $medio . " y los demas son iguales.";
    } else {
        echo "El número menor es " . $minimo . " y el mayor es". $maximo;
    }
    }
