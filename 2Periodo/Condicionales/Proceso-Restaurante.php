...
<body class="is-preload">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        switch ($orden) {
            case '1':
                $pedido = 'Coca-Cola Personal';
                $precio = 3500;
                break;

            case '2':
                $pedido = 'Hamburgesa Pollo';
                $precio = 7000;
                break;

            case '3':
                $pedido = 'Hamburgesa Doble-Queso';
                $precio = 6500;
                break;

            case '4':
                $pedido = 'Perro Caliente';
                $precio = 7000;
                break;
    ...
    echo "¡Su pedido esta en camino! Orden pedida: ". $pedido ." | Precio: $". $precio;
    ?>
                    </div>
                </section>
