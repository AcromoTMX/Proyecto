...
<body class="is-preload">
            ...
            <div class="inner">
                ...
                <section id="banner">
                    <div class="content">
                        ...
                        <form method="POST">
        <label for="user">Ingrese el nombre de usuario: </label>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($user == "UsuJG" && $pass == "PassJG") {
            echo "Bienvenido, los datos coinciden con una cuenta registrada, tienes acceso completo a la aplicacion";
        } elseif ($user == "InvJG" && $pass == "InvPassJG") {
            echo "Bienvenido, al ser un usuario invitado no tienes acceso completo, ingresa datos registrados para tener el acceso";
        }
    }
    ?>
                    </div>
