...
<body class="is-preload">
    ...
    $i = 0;
    $tareas = [
        "1. Pasear al perro" => false,
        "2. Comprar ropa" => false,
        "3. Estudiar programación" => false,
        "4. Arreglar la moto" => false,
        "5. Arreglar la moto" => false
    ];
    ...
    if (isset($_POST['Marcar'])) {
        ...
        if ($check  == 1) {
    if (array_key_exists($check, $tareas)) {
        $tareas[$check] = true;
    }
    }
    }
    ...
    <form action="POST">
        <p>Digite el numero de la tera completada: </p>
